    ...
    {/* {JSON.stringify(typeof message)} */}
      ...
      {typeof message === 'string' ? (
        ...
        <div className="text-sm max-w-[230px] md:max-w-[80%] mt-7 mb-7">
          ...
          {showResult ? <p className="text-[11px] rounded-md bg-[#ececec] dark:bg-shadeA mt-3 p-4 leading-4 relative">
            <strong>Reasoning:</strong> {message.query_sources.reasoning}
            <span className="absolute right-2 bottom-1 cursor-pointer" onClick={() => setShowResult(false)}>X</span>
          </p> : null}
