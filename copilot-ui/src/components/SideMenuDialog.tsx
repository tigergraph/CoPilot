...
const SideMenuDialog = ({ height }: { height: string }) => {
  ...
  return (
    <div
      className={`hidden md:block w-[320px] md:min-w-[320px] overflow-y-auto ${height ? "h-[70vh]" : "h-[100vh]"}`}
    >
      ...
      <h4 className="Urbane-Light text-sm pl-6 pt-5 text-black dark:text-white">
        Today
      </h4>
      <ul className="menu border-b border-gray-300 dark:border-[#3D3D3D] text-black mx-6">
        <li className="text-ellipsis">
          <a href="#" className="flex py-3 my-3 px-3 items-center">
            <PiNumberCircleSevenLight className="text-xl mr-3" />
            How many transactions...
          </a>
        </li>
        <li>
          <a href="#" className="flex py-3 my-3 px-3 items-center">
            <PiNumberCircleFiveLight className="text-xl mr-3" />
      ...
      <ul className="menu border-b border-gray-300 dark:border-[#3D3D3D] text-black dark:text-white mx-6">
        <li className="text-ellipsis">
          <a href="#" className="flex py-3 my-3 px-3 items-center">
            <PiNumberCircleTwoLight className="text-xl mr-3" />
      ...
      <div
        className={`hidden md:block w-[320px] md:max-w-[320px] absolute bg-white dark:bg-background rounded-bl-3xl dark:border-[#3D3D3D] border-t ${height ? "open-dialog-avatar" : "bottom-0"}`}
      >
