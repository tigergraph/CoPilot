...
branch_name = os.getenv("PR_NUMBER", Repository('../build').head.shorthand)
...
python_filter = "branch == '" + branch_name +"' and commit_hash == '" + Repository(
    '../build').head.peel(Commit).id.hex + "'"
